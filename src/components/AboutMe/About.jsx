        ...
        <section className="sec-container" id="aboutMe">
            ...
            <div>
                <p>
                    ...
                    Disfruto trabajar en equipo, ya sea con clientes y asociados, o bien siendo parte de una empresa. Creo que es fundamental el diálogo, apreciar cada punto de vista, potenciar las fortalezas de cada integrante y agrupar los conceptos recogidos, desarrollando una gran idea que culmine en proyectos exitosos.
